...
public class Location implements Comparable<Location> {
  ...
  /**
   * Two locations are considered equal if they have the same row and column values.
   *
   ...
   *
   * @returns A negative integer, zero, or a positive integer as this location is less than, equal
   *          to, or greater than the other location in a row-major ordering.
   */
  @Override
