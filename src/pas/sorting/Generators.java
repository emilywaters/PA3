...
public class Generators {
  ...
  /**
   * Generate a random sequence of Integers with the indicated size. The entries in the resulting
   * sequence will be drawn from all possible integers with equal probability.
   */
  ...
  /**
   * Generate an sequence of Integers with the indicated size. The entries in the resulting sequence
   * will be in the range 0 to size-1.
   */
