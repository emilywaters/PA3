...
public class SortProfiler {
  private static final String[] ALL_SORT_NAMES =
    {"insertion", "selection", "merge", "merge_half", "merge_adaptive", "quick", "introspective", "timsort"};
   ...
   */
  public SortProfiler(List<Sorter<Integer>> sorts, List<String> sortNames, int start,
  ...
  public static void main(String[] args) throws IOException {
    ...
    OptionSpec<String> sortSpec = parser.accepts("w",
        "Comma separated list of sorts. Options include insertion, selection, merge, merge_half, merge_adaptive, quick, introspective and timsort. Default is to execute all sorts.")
